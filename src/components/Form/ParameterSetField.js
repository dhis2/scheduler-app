...
import { actions, selectors } from '../../data/parameter-options'
...
export const UnconnectedParameterSetField = ({
    ...
    useEffect(() => {
        fetchParameterOptionsIfNeeded(endpoint, jobType, parameterName)
    }, [fetchParameterOptionsIfNeeded, endpoint, jobType, parameterName])
...
UnconnectedParameterSetField.propTypes = {
    ...
    fetchParameterOptionsIfNeeded: func.isRequired,
...
const mapStateToProps = (state, ownProps) => {
    ...
    const parameterOptions = rootSelectors.getParameterOptions(state)
    ...
    return {
        ...
        didFetch: selectors.getDidFetch(
            parameterOptions,
            jobType,
            parameterName
        ),
        ...
        options: selectors.getParameterOptions(
            parameterOptions,
            jobType,
            parameterName
        ),
...
const mapDispatchToProps = {
    fetchParameterOptionsIfNeeded: actions.fetchParameterOptionsIfNeeded,
}
